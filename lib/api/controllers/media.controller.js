...
exports.downloadWhatsAppImage = exports.downloadWhatsAppAudio = void 0;
 ...
 */
const downloadWhatsAppImage = async (req, res) => {
    try {
        const { url, mediaKey, fileEncSha256 } = req.body;
        // Validate required fields using media service
        const validation = media_service_1.default.validateImageFields(url, mediaKey, fileEncSha256);
        if (!validation.isValid) {
            return res.status(http_status_codes_1.StatusCodes.BAD_REQUEST).json({
                success: false,
                error: validation.error,
        ...
        const mediaBuffer = await media_service_1.default.downloadAndDecryptImage(url, mediaKey, fileEncSha256);
...
exports.downloadWhatsAppImage = downloadWhatsAppImage;
