...
class MediaService {
     ...
     */
    async downloadAndDecryptAudio(url, mediaKey, fileEncSha256) {
        ...
        let mediaBuffer;
        try {
            mediaBuffer = await downloadMediaMessage(messageForBaileys, 'buffer', {}, {
     ...
     */
    async downloadAndDecryptImage(url, mediaKey, fileEncSha256) {
        // Import WhatsApp client service and Baileys
        let clientService, client, downloadMediaMessage;
        try {
            clientService = require('./client.service').default;
     ...
     */
    validateAudioFields(url, mediaKey, fileEncSha256) {
     ...
     * @returns Object with validation result and error message if any
     */
    validateImageFields(url, mediaKey, fileEncSha256) {
        if (!url || !mediaKey || !fileEncSha256) {
            return {
                isValid: false,
                error: 'url, mediaKey, and fileEncSha256 fields are required.',
...
exports.default = MediaService.getInstance();
